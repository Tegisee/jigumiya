...
- **쿠팡 파트너스 reco v2 API 연동 (ADID 기반 개인화 추천)** — Phase 3-C 이후 검토. 분당 100회 한도로 /products/search의 2배 여유. 홈 "오늘의 추천" 섹션 또는 자주사는상품 기반 유사 상품 추천 활용. iOS ATT 권한 필요 (허용률 30~40% 현실). 상세: docs/010 §reco v2 API 검토
